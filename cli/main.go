...
func main() {
	...
	err := connectDirect(*td, *APIRegistration, *registrar, *connectTarget, *port, *proxyHeader, v6Support, *width, *transport, *randomizeDstPort)
	if err != nil {
...
func connectDirect(td bool, apiEndpoint string, registrar string, connectTarget string, localPort int, proxyHeader bool, v6Support bool, width int, transport string, randomizeDstPort bool) error {
