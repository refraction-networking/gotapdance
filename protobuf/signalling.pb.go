...
var file_signalling_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x7f,
	0x0a, 0x0a, 0x5a, 0x4d, 0x51, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x23, 0x0a, 0x0d,
	...
	0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22,
	...
	0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x10, 0x02,
}
...
var file_signalling_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
...
var file_signalling_proto_goTypes = []interface{}{
	...
	(*TLSDecoySpec)(nil),      // 6: tapdance.TLSDecoySpec
	(*ClientConf)(nil),        // 7: tapdance.ClientConf
	(*DecoyList)(nil),         // 8: tapdance.DecoyList
	(*DarkDecoyBlocks)(nil),   // 9: tapdance.DarkDecoyBlocks
	(*StationToClient)(nil),   // 10: tapdance.StationToClient
	(*RegistrationFlags)(nil), // 11: tapdance.RegistrationFlags
	(*ClientToStation)(nil),   // 12: tapdance.ClientToStation
	(*ClientToAPI)(nil),       // 13: tapdance.ClientToAPI
	(*ZMQPayload)(nil),        // 14: tapdance.ZMQPayload
	(*SessionStats)(nil),      // 15: tapdance.SessionStats
}
var file_signalling_proto_depIdxs = []int32{
	0,  // 0: tapdance.PubKey.type:type_name -> tapdance.KeyType
	5,  // 1: tapdance.TLSDecoySpec.pubkey:type_name -> tapdance.PubKey
	8,  // 2: tapdance.ClientConf.decoy_list:type_name -> tapdance.DecoyList
	5,  // 3: tapdance.ClientConf.default_pubkey:type_name -> tapdance.PubKey
	9,  // 4: tapdance.ClientConf.dark_decoy_blocks:type_name -> tapdance.DarkDecoyBlocks
	5,  // 5: tapdance.ClientConf.conjure_pubkey:type_name -> tapdance.PubKey
	6,  // 6: tapdance.DecoyList.tls_decoys:type_name -> tapdance.TLSDecoySpec
	2,  // 7: tapdance.StationToClient.state_transition:type_name -> tapdance.S2C_Transition
	7,  // 8: tapdance.StationToClient.config_info:type_name -> tapdance.ClientConf
	...
	15, // 11: tapdance.ClientToStation.stats:type_name -> tapdance.SessionStats
	4,  // 12: tapdance.ClientToStation.transport:type_name -> tapdance.TransportType
	11, // 13: tapdance.ClientToStation.flags:type_name -> tapdance.RegistrationFlags
	12, // 14: tapdance.ClientToAPI.registration_payload:type_name -> tapdance.ClientToStation
	12, // 15: tapdance.ZMQPayload.registration_payload:type_name -> tapdance.ClientToStation
