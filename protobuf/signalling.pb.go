...
type ClientToStation struct {
	...
	MaskedDecoyServerName *string `protobuf:"bytes,21,opt,name=masked_decoy_server_name" json:"masked_decoy_server_name,omitempty"`
	// Used to indicate to server if client doesn't support ipv6 for dark decoy address selection.
	V6Support *bool `protobuf:"varint,22,opt,name=v6_support" json:"v6_support,omitempty"`
	// Random-sized junk to defeat packet size fingerprinting.
	Padding              []byte   `protobuf:"bytes,100,opt,name=padding" json:"padding,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
...
var fileDescriptor_39f66308029891ad = []byte{
	...
	,
}
