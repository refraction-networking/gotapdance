...
const (
	...
	TransportType_Webrtc TransportType = 3 // DTLS transport, yay
)
...
type WebrtcRandseed struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Seed         *string `protobuf:"bytes,1,opt,name=seed" json:"seed,omitempty"`
	SharedSecret *string `protobuf:"bytes,2,opt,name=shared_secret,json=sharedSecret" json:"shared_secret,omitempty"`
}

func (x *WebrtcRandseed) Reset() {
	*x = WebrtcRandseed{}
	if protoimpl.UnsafeEnabled {
...
func (x *WebrtcRandseed) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WebrtcRandseed) ProtoMessage() {}

func (x *WebrtcRandseed) ProtoReflect() protoreflect.Message {
	mi := &file_signalling_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WebrtcRandseed.ProtoReflect.Descriptor instead.
func (*WebrtcRandseed) Descriptor() ([]byte, []int) {
	return file_signalling_proto_rawDescGZIP(), []int{7}
}

func (x *WebrtcRandseed) GetSeed() string {
	if x != nil && x.Seed != nil {
		return *x.Seed
	}
	return ""
...
func (x *WebrtcRandseed) GetSharedSecret() string {
...
type WebrtcSDP struct {
	...
	RandSeed     *WebrtcRandseed `protobuf:"bytes,2,opt,name=rand_seed,json=randSeed" json:"rand_seed,omitempty"`
}
...
func (x *WebrtcSDP) GetRandSeed() *WebrtcRandseed {
	if x != nil {
		return x.RandSeed
	}
	return nil
...
type ClientToStation struct {
	...
	// Everything required from the client for a WebRTC Peer Connection
...
var file_signalling_proto_rawDesc = []byte{
	...
	,
	...
	0x72, 0x65, 0x73, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x64, 0x22, 0xf8, 0x04, 0x0a, 0x0f, 0x43, 0x6c,
	...
	0x65, 0x52, 0x09, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x2b, 0x0a, 0x06,
	0x77, 0x65, 0x62, 0x72, 0x74, 0x63, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x74,
	0x61, 0x70, 0x64, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x57, 0x65, 0x62, 0x72, 0x74, 0x63, 0x53, 0x44,
	0x50, 0x52, 0x06, 0x77, 0x65, 0x62, 0x72, 0x74, 0x63, 0x12, 0x25, 0x0a, 0x0e, 0x63, 0x6f, 0x76,
	...
	0x61, 0x67, 0x73, 0x52, 0x05, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x61,
	...
	0x4e, 0x73, 0x22, 0x9c, 0x01, 0x0a, 0x14, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74,
	...
	0x72, 0x2a, 0x2b, 0x0a, 0x07, 0x4b, 0x65, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0f, 0x0a, 0x0b,
...
var file_signalling_proto_goTypes = []interface{}{
	...
	(*WebrtcRandseed)(nil),       // 13: tapdance.WebrtcRandseed
...
var file_signalling_proto_depIdxs = []int32{
	...
	13, // 9: tapdance.WebrtcSDP.rand_seed:type_name -> tapdance.WebrtcRandseed
	...
	14, // 16: tapdance.ClientToStation.webrtc:type_name -> tapdance.WebrtcSDP
	16, // 17: tapdance.ClientToStation.flags:type_name -> tapdance.RegistrationFlags
