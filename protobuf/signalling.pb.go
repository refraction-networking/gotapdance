...
const (
	...
	TransportType_Webrtc TransportType = 3 // UDP transport: WebRTC DataChannel
)
...
type WebrtcSDP struct {
	...
	IpUpper      *uint64 `protobuf:"varint,2,opt,name=ip_upper,json=ipUpper" json:"ip_upper,omitempty"` // ip := upper << 64 | lower
...
func (x *WebrtcSDP) GetSdpType() uint32 {
...
func (x *WebrtcSDP) GetIpUpper() uint64 {
...
func (x *WebrtcSDP) GetIpLower() uint64 {
...
func (x *WebrtcSDP) GetComposedInfo() uint32 {
...
type WebrtcSignalling struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	WebrtcSdps []*WebrtcSDP `protobuf:"bytes,1,rep,name=webrtc_sdps,json=webrtcSdps" json:"webrtc_sdps,omitempty"`
	WebrtcSeed *string      `protobuf:"bytes,2,opt,name=webrtc_seed,json=webrtcSeed" json:"webrtc_seed,omitempty"`
}

func (x *WebrtcSignalling) Reset() {
	*x = WebrtcSignalling{}
	if protoimpl.UnsafeEnabled {
...
func (x *WebrtcSignalling) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WebrtcSignalling) ProtoMessage() {}

func (x *WebrtcSignalling) ProtoReflect() protoreflect.Message {
	mi := &file_signalling_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WebrtcSignalling.ProtoReflect.Descriptor instead.
func (*WebrtcSignalling) Descriptor() ([]byte, []int) {
	return file_signalling_proto_rawDescGZIP(), []int{7}
}

func (x *WebrtcSignalling) GetWebrtcSdps() []*WebrtcSDP {
	if x != nil {
		return x.WebrtcSdps
	}
	return nil
...
func (x *WebrtcSignalling) GetWebrtcSeed() string {
	if x != nil && x.WebrtcSeed != nil {
		return *x.WebrtcSeed
	}
	return ""
}
...
type ClientToStation struct {
	...
	WebrtcSignalling *WebrtcSignalling `protobuf:"bytes,31,opt,name=webrtc_signalling,json=webrtcSignalling" json:"webrtc_signalling,omitempty"`
	// Random-sized junk to defeat packet size fingerprinting.
	Padding []byte `protobuf:"bytes,100,opt,name=padding" json:"padding,omitempty"`
}
...
func (x *ClientToStation) GetWebrtcSignalling() *WebrtcSignalling {
	if x != nil {
		return x.WebrtcSignalling
	}
	return nil
}
...
var file_signalling_proto_rawDesc = []byte{
	...
	,
	...
	0x73, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x64, 0x22, 0x94, 0x05, 0x0a, 0x0f, 0x43, 0x6c, 0x69, 0x65,
	...
	0x09, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x25, 0x0a, 0x0e, 0x63, 0x6f,
	...
	0x6c, 0x61, 0x67, 0x73, 0x52, 0x05, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x12, 0x47, 0x0a, 0x11, 0x77,
	0x65, 0x62, 0x72, 0x74, 0x63, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x6c, 0x69, 0x6e, 0x67,
	0x18, 0x1f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x74, 0x61, 0x70, 0x64, 0x61, 0x6e, 0x63,
	0x65, 0x2e, 0x57, 0x65, 0x62, 0x72, 0x74, 0x63, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x6c, 0x69,
	0x6e, 0x67, 0x52, 0x10, 0x77, 0x65, 0x62, 0x72, 0x74, 0x63, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x6c,
	0x6c, 0x69, 0x6e, 0x67, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x61, 0x64, 0x64, 0x69, 0x6e, 0x67, 0x18,
	...
	0x02, 0x12, 0x0a, 0x0a, 0x06, 0x57, 0x65, 0x62, 0x72, 0x74, 0x63, 0x10, 0x03, 0x2a, 0x67, 0x0a,
...
var file_signalling_proto_goTypes = []interface{}{
	...
	(*WebrtcSDP)(nil),            // 12: tapdance.WebrtcSDP
	(*WebrtcSignalling)(nil),     // 13: tapdance.WebrtcSignalling
...
var file_signalling_proto_depIdxs = []int32{
	...
	12, // 8: tapdance.WebrtcSignalling.webrtc_sdps:type_name -> tapdance.WebrtcSDP
	...
	15, // 15: tapdance.ClientToStation.flags:type_name -> tapdance.RegistrationFlags
	13, // 16: tapdance.ClientToStation.webrtc_signalling:type_name -> tapdance.WebrtcSignalling
	...
	8,  // 20: tapdance.RegistrationResponse.clientConf:type_name -> tapdance.ClientConf
