...
var file_signalling_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x6f, 0x79, 0x22, 0xdf, 0x01, 0x0a, 0x11, 0x53, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x72, 0x63, 0x50, 0x6f, 0x72, 0x74, 0x22, 0xd2, 0x01, 0x0a, 0x14, 0x52, 0x65, 0x67, 0x69, 0x73,
	...
	0x70, 0x76, 0x36, 0x61, 0x64, 0x64, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x22, 0x0a, 0x0c, 0x73,
	...
	0x0a, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x22, 0xaf, 0x01, 0x0a, 0x0b,
	...
	0x50, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x44, 0x4f, 0x54, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03,
	0x44, 0x4f, 0x48, 0x10, 0x02, 0x2a, 0xe7, 0x01, 0x0a, 0x0e, 0x43, 0x32, 0x53, 0x5f, 0x54, 0x72,
	...
	0x54, 0x49, 0x4d, 0x45, 0x4f, 0x55, 0x54, 0x10, 0x65, 0x2a, 0x39, 0x0a, 0x0d, 0x54, 0x72, 0x61,
	...
	0x05, 0x4f, 0x62, 0x66, 0x73, 0x34, 0x10, 0x02, 0x12, 0x0a, 0x0a, 0x06, 0x57, 0x65, 0x62, 0x72,
	0x74, 0x63, 0x10, 0x63, 0x2a, 0x86, 0x01, 0x0a, 0x12, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72,
	...
	0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x44, 0x4e, 0x53, 0x10, 0x06, 0x2a, 0x40, 0x0a,
	0x11, 0x53, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x6e, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x10, 0x00, 0x12,
	0x07, 0x0a, 0x03, 0x4e, 0x65, 0x77, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x10, 0x02, 0x12, 0x09, 0x0a, 0x05, 0x43, 0x6c, 0x65, 0x61, 0x72, 0x10, 0x03,
}
...
var file_signalling_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
...
var file_signalling_proto_goTypes = []interface{}{
	...
	(*PubKey)(nil),               // 8: tapdance.PubKey
	(*TLSDecoySpec)(nil),         // 9: tapdance.TLSDecoySpec
	(*ClientConf)(nil),           // 10: tapdance.ClientConf
	(*DnsRegConf)(nil),           // 11: tapdance.DnsRegConf
	(*DecoyList)(nil),            // 12: tapdance.DecoyList
	(*PhantomSubnetsList)(nil),   // 13: tapdance.PhantomSubnetsList
	(*PhantomSubnets)(nil),       // 14: tapdance.PhantomSubnets
	(*WebRTCICECandidate)(nil),   // 15: tapdance.WebRTCICECandidate
	(*WebRTCSDP)(nil),            // 16: tapdance.WebRTCSDP
	(*WebRTCSignal)(nil),         // 17: tapdance.WebRTCSignal
	(*StationToClient)(nil),      // 18: tapdance.StationToClient
	(*RegistrationFlags)(nil),    // 19: tapdance.RegistrationFlags
	(*ClientToStation)(nil),      // 20: tapdance.ClientToStation
	(*C2SWrapper)(nil),           // 21: tapdance.C2SWrapper
	(*SessionStats)(nil),         // 22: tapdance.SessionStats
	(*StationToDetector)(nil),    // 23: tapdance.StationToDetector
	(*RegistrationResponse)(nil), // 24: tapdance.RegistrationResponse
	(*DnsResponse)(nil),          // 25: tapdance.DnsResponse
}
var file_signalling_proto_depIdxs = []int32{
	0,  // 0: tapdance.PubKey.type:type_name -> tapdance.KeyType
	8,  // 1: tapdance.TLSDecoySpec.pubkey:type_name -> tapdance.PubKey
	12, // 2: tapdance.ClientConf.decoy_list:type_name -> tapdance.DecoyList
	8,  // 3: tapdance.ClientConf.default_pubkey:type_name -> tapdance.PubKey
	13, // 4: tapdance.ClientConf.phantom_subnets_list:type_name -> tapdance.PhantomSubnetsList
	8,  // 5: tapdance.ClientConf.conjure_pubkey:type_name -> tapdance.PubKey
	1,  // 6: tapdance.DnsRegConf.dns_reg_method:type_name -> tapdance.DnsRegMethod
	9,  // 7: tapdance.DecoyList.tls_decoys:type_name -> tapdance.TLSDecoySpec
	14, // 8: tapdance.PhantomSubnetsList.weighted_subnets:type_name -> tapdance.PhantomSubnets
	15, // 9: tapdance.WebRTCSDP.candidates:type_name -> tapdance.WebRTCICECandidate
	16, // 10: tapdance.WebRTCSignal.sdp:type_name -> tapdance.WebRTCSDP
	3,  // 11: tapdance.StationToClient.state_transition:type_name -> tapdance.S2C_Transition
	10, // 12: tapdance.StationToClient.config_info:type_name -> tapdance.ClientConf
	...
	22, // 15: tapdance.ClientToStation.stats:type_name -> tapdance.SessionStats
	5,  // 16: tapdance.ClientToStation.transport:type_name -> tapdance.TransportType
	19, // 17: tapdance.ClientToStation.flags:type_name -> tapdance.RegistrationFlags
	17, // 18: tapdance.ClientToStation.webrtc_signal:type_name -> tapdance.WebRTCSignal
	20, // 19: tapdance.C2SWrapper.registration_payload:type_name -> tapdance.ClientToStation
	6,  // 20: tapdance.C2SWrapper.registration_source:type_name -> tapdance.RegistrationSource
	24, // 21: tapdance.C2SWrapper.registration_response:type_name -> tapdance.RegistrationResponse
	7,  // 22: tapdance.StationToDetector.operation:type_name -> tapdance.StationOperations
	10, // 23: tapdance.RegistrationResponse.clientConf:type_name -> tapdance.ClientConf
	24, // 24: tapdance.DnsResponse.bidirectional_response:type_name -> tapdance.RegistrationResponse
