...
require (
	...
	github.com/refraction-networking/conjure v0.4.4
...
replace github.com/refraction-networking/conjure => github.com/mingyech/conjure v0.2.1-0.20230714085809-f8f625c23b4c
