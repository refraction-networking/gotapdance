...
require (
	...
	github.com/refraction-networking/conjure v0.6.4
...
replace github.com/refraction-networking/conjure => github.com/refraction-networking/conjure v0.6.5-0.20230815092952-67bdb36bf3ee
